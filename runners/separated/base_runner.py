...
class Runner(object):
    def __init__(self, config):
        ...
        elif self.all_args.algorithm_name == "haa2c":
            from algorithms.haa2c_trainer import HAA2C as TrainAlgo
            from algorithms.happo_policy import HAPPO_Policy as Policy
        elif self.all_args.algorithm_name == "maa2c":
            from algorithms.maa2c_trainer import MAA2C as TrainAlgo
            from algorithms.happo_policy import HAPPO_Policy as Policy
    ...
    def train(self):
        ...
        for agent_id in torch.randperm(self.num_agents):
            ...
            if self.all_args.algorithm_name in ["hatrpo", "happo", "haa2c"]:
                ...
                elif self.all_args.algorithm_name == "happo" or self.all_args.algorithm_name == "haa2c":
